...
const GameplayPage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        <li>Creatures: Main battling units from 4 elements (Air, Water, Fire, Earth) and 6 combinational elements for Dragons.</li>
        <li>Runes: Types include Normal, Equipments, and Instants. Have a variety of effects that can support your strategy or disrupt your opponent's. Can be activated the turn you place them.</li>
        <li>Counters: Can be activated during either player's turn, often in response to specific actions. Provide surprise elements and ways to counter your opponent's moves. Must be Set face-down for one turn before they can be activated.</li>
        <li>Shields: Your last line of defense, providing a choice between powerful effects when broken.</li>
        <li>Essence: Resource generated by creatures, used to play cards and activate abilities. Treated as an in-game currency.</li>
      </ul>
      <p className="mb-4">
