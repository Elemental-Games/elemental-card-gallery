...
COMMENT ON TABLE public.alpha_waitlist IS 'Closed Alpha tester waitlist and optional profile questionnaire';
...
COMMENT ON TABLE public.creator_applications IS 'Creator Program applications from /creators';
