    ...
    <div className="w-full">
      ...
      >
        ...
        <p className="text-center text-purple-200 text-lg">
          <span className="text-yellow-400 font-semibold">Scan any card&apos;s QR code</span> to learn more about the card's mechanics, best decks, synergies, counters, combos, oracle text, and much more! This will be fully implemented post-launch when our full 175-card set is released.
        </p>
      </motion.div>
    </div>
  );
