  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        ...
        <li>Destroy your opponent's shields and reduce their life points to zero to win!</li>
      ...
      <ul className="list-disc list-inside mb-6 space-y-2">
        ...
        <li>Runes & Counters: Support cards similar to spell cards in other TCGs.</li>
        <li>Shields: Your last line of defense, providing powerful effects when broken.</li>
        <li>Essence: Resource generated by creatures, used to play cards and activate abilities.</li>
      </ul>
      <p className="mb-4">
