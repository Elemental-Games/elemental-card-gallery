...
const regions = [
  { id: 'zalos', name: 'Zalos', path: 'M50,50 L300,50 L250,200 Z', color: 'blue' },
  ...
  { id: 'grivoss', name: 'Grivoss', path: 'M50,650 L200,700 L150,850 L50,800 Z', color: 'orange' },
  { id: 'arid-sands', name: 'Arid Sands', path: 'M200,800 L400,850 L350,950 L200,900 Z', color: 'yellow' },
  { id: 'evermere', name: 'Evermere', path: 'M300,300 L700,300 L600,600 L400,600 Z', color: 'green' },
  { id: 'tsunareth', name: 'Tsunareth', path: 'M500,750 L750,800 L700,900 L450,850 Z', color: 'lightblue' },
