      ...
      <AnimatePresence>
        {showOriginalBox && (
          <motion.div
            ...
            className="bg-popover p-8 rounded-lg max-w-4xl w-full relative border-4 border-accent flex flex-col items-center"
          >
            <Button
              onClick={onClose}
              variant="ghost"
      ...
      <AnimatePresence>
        {showThankYou && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className="bg-yellow-300 p-4 rounded-lg shadow-lg"
          >
