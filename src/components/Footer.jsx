    ...
    <footer className="bg-darkPurple text-white py-8 w-full mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Elekin TCG</h3>
            <ul className="space-y-2">
            <li><Link to="/elekin" className="hover:text-accent transition-colors">Cards of the Week</Link></li>
              <li><Link to="/cards/campaign" className="hover:text-accent transition-colors">Card Campaign</Link></li>
          ...
          <div>
            ...
            <a href="https://discord.gg/PVrgZBmcMq" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">
                <svg 
              ...
              <a href="https://www.tiktok.com/@elekin_tcg" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">
                <svg 
                  className="h-6 w-6 fill-current text-white"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <a href="https://www.instagram.com/elekin_tcg/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">
                <svg 
                  className="h-6 w-6 fill-current text-white"
                  viewBox="0 0 24 24"
                  fill="currentColor"
