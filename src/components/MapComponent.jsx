...
const regions = [
  ...
  { name: 'tsunareth', path: "M1150,1100 Q1230,1080 1300,1120 Q1370,1160 1410,1230 Q1450,1300 1450,1380 Q1450,1460 1410,1530 L1150,1530 L1150,1100 Z", route: '/tsunareth', fill: "rgba(0, 0, 255, 0.3)" },
