  ...
  return (
    ...
    >
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Welcome to Elemental Masters! This guide will help you understand the basics of the game and get you started on your journey to becoming an Elemental Master.</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Once you've mastered the basics, check out this video on advanced strategies:</p>
        <div className="aspect-w-16 aspect-h-9 mb-4">
          <iframe
            src="https://www.youtube.com/embed/dQw4w9WgXcQ"
            frameBorder="0"
