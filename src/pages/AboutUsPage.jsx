      ...
      <div className="flex flex-col md:flex-row items-start mb-2">
        <div className="md:w-2/3 md:pr-8">
          ...
          <p className="mb-4">
            ...
            <br />
            <br />
            "<span className="text-accent">This journey with Elemental Games began years ago as a passion project</span>, and I was thrilled to see it evolve into an official LLC in 2024. As we approach our Kickstarter launch on <span className="text-accent">February 7th, 2025</span>, I'm incredibly grateful for the support from our engineers, beta-testers, and artists who have helped shape this vision along the way. What started as a solo project is growing into something bigger, and <span className="text-accent">I'm excited to expand our team and bring the world of Kinbrold to life in the coming  ear.</span>" - Mark Diorio
          </p>
        </div>
